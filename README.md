...
- **Stack:** Next.js 15 PWA + NestJS 11 (modular monolith) + **PostgreSQL 17** + Redis + S3/MinIO + Orthanc PACS,
  deployable to cloud *or* inside the hospital. TypeScript everywhere, one contracts package shared by both ends.
...
*Prepared for VIMS ENTERPRISE. Sources analysed: the 151-module master sheet, the ₹343.75L / 2713 man-day FAMI CARE
costed proposal, and the Aosta BackBone, MocDoc, SMART HMIS, SmartHospital India and PCS Prodoc brochures, plus
2026 market and regulatory research.*
