...
/**
 * Phase 7E and 7F outbox events, checked against the registry before they are written.
 *
 * Same shape and the same reason as `fracture.events.ts`.
 */
export function criticalCareEvent(
  type: string,
  aggregateId: string,
