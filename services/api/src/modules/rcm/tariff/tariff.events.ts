...
/**
 * RC-003 outbox events, validated against the registry before they are written.
 *
 * Same shape and the same reason as `modules/inventory/inventory.events.ts`: the
