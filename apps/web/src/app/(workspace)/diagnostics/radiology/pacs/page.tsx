...
import { PacsScreen } from '@/features/diagnostics/components/pacs-screen';

export const metadata: Metadata = { title: "PACS studies · Vim's HMS" };
...
export default function Page(): React.JSX.Element {
  return (
    <DiagnosticsGate screenKey="rad-pacs">
      <PacsScreen />
    </DiagnosticsGate>
  );
}
