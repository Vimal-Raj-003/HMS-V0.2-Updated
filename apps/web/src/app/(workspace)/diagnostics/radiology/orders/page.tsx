...
import { RadOrderScreen } from '@/features/diagnostics/components/rad-order-screen';

export const metadata: Metadata = { title: "Imaging orders · Vim's HMS" };
...
export default function Page(): React.JSX.Element {
  return (
    <DiagnosticsGate screenKey="rad-orders">
      <RadOrderScreen />
    </DiagnosticsGate>
  );
}
