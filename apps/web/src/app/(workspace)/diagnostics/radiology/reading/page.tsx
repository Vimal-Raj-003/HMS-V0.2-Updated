...
import { RadReadingScreen } from '@/features/diagnostics/components/rad-reading-screen';

export const metadata: Metadata = { title: "Reading worklist · Vim's HMS" };
...
export default function Page(): React.JSX.Element {
  return (
    <DiagnosticsGate screenKey="rad-reading">
      <RadReadingScreen />
    </DiagnosticsGate>
  );
}
