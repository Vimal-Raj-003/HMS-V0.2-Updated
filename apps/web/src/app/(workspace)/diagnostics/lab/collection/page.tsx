...
import { LabCollectionScreen } from '@/features/diagnostics/components/lab-collection-screen';

export const metadata: Metadata = { title: "Sample collection · Vim's HMS" };
...
export default function Page(): React.JSX.Element {
  return (
    <DiagnosticsGate screenKey="lab-collection">
      <LabCollectionScreen />
    </DiagnosticsGate>
  );
}
