...
import { LabQcScreen } from '@/features/diagnostics/components/lab-qc-screen';

export const metadata: Metadata = { title: "Quality control · Vim's HMS" };
...
export default function Page(): React.JSX.Element {
  return (
    <DiagnosticsGate screenKey="lab-qc">
      <LabQcScreen />
    </DiagnosticsGate>
  );
}
