...
import { InvestigationsScreen } from '@/features/diagnostics/components/investigations-screen';

export const metadata: Metadata = { title: "Investigation console · Vim's HMS" };
...
export default function Page(): React.JSX.Element {
  return (
    <DiagnosticsGate screenKey="investigations">
