...
import { GrnScreen } from '@/features/inventory/components/grn-screen';

export const metadata: Metadata = { title: "Goods receipt · Vim's HMS" };
...
export default function Page(): React.JSX.Element {
  return (
    <InventoryGate screenKey="inventory-grn">
      <GrnScreen />
    </InventoryGate>
  );
}
