...
import { PurchaseScreen } from '@/features/inventory/components/purchase-screen';

export const metadata: Metadata = { title: "Purchase orders · Vim's HMS" };
...
export default function Page(): React.JSX.Element {
  return (
    <InventoryGate screenKey="inventory-purchase">
      <PurchaseScreen />
    </InventoryGate>
  );
}
