...
import { IndentsScreen } from '@/features/inventory/components/indents-screen';

export const metadata: Metadata = { title: "Indents & issues · Vim's HMS" };
...
export default function Page(): React.JSX.Element {
  return (
    <InventoryGate screenKey="inventory-indents">
      <IndentsScreen />
    </InventoryGate>
  );
}
