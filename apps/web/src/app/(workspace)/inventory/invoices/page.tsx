...
import { InvoicesScreen } from '@/features/inventory/components/invoices-screen';

export const metadata: Metadata = { title: "Three-way match · Vim's HMS" };
...
export default function Page(): React.JSX.Element {
  return (
    <InventoryGate screenKey="inventory-invoices">
      <InvoicesScreen />
    </InventoryGate>
  );
}
