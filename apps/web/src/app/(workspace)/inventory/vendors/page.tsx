...
import { VendorsScreen } from '@/features/inventory/components/vendors-screen';

export const metadata: Metadata = { title: "Vendors · Vim's HMS" };
...
export default function Page(): React.JSX.Element {
  return (
    <InventoryGate screenKey="inventory-vendors">
      <VendorsScreen />
    </InventoryGate>
  );
}
