...
import { AdjustmentsScreen } from '@/features/inventory/components/adjustments-screen';

export const metadata: Metadata = { title: "Adjustments & counts · Vim's HMS" };
...
export default function Page(): React.JSX.Element {
  return (
    <InventoryGate screenKey="inventory-adjustments">
      <AdjustmentsScreen />
    </InventoryGate>
  );
}
