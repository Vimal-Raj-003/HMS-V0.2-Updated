...
import { TransfersScreen } from '@/features/inventory/components/transfers-screen';

export const metadata: Metadata = { title: "Transfers · Vim's HMS" };
...
export default function Page(): React.JSX.Element {
  return (
    <InventoryGate screenKey="inventory-transfers">
      <TransfersScreen />
    </InventoryGate>
  );
}
