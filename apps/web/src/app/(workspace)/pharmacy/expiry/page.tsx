...
import { ExpiryScreen } from '@/features/pharmacy/components/expiry-screen';

export const metadata: Metadata = { title: "Expiry & near-expiry · Vim's HMS" };
...
export default function Page(): React.JSX.Element {
  return (
    <PharmacyGate screenKey="pharmacy-expiry">
      <ExpiryScreen />
    </PharmacyGate>
  );
}
