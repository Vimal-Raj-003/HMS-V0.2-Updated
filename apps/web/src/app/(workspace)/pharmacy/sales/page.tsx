...
import { CounterSalesScreen } from '@/features/pharmacy/components/counter-sales-screen';

export const metadata: Metadata = { title: "Counter sales · Vim's HMS" };
...
export default function Page(): React.JSX.Element {
  return (
    <PharmacyGate screenKey="pharmacy-sales">
      <CounterSalesScreen />
    </PharmacyGate>
  );
}
