...
import { DispenseCounterScreen } from '@/features/pharmacy/components/dispense-counter-screen';

export const metadata: Metadata = { title: "Dispensing counter · Vim's HMS" };
...
export default function Page(): React.JSX.Element {
  return (
    <PharmacyGate screenKey="pharmacy-counter">
      <DispenseCounterScreen />
    </PharmacyGate>
  );
}
