...
import { ReturnsScreen } from '@/features/pharmacy/components/returns-screen';

export const metadata: Metadata = { title: "Returns desk · Vim's HMS" };
...
export default function Page(): React.JSX.Element {
  return (
    <PharmacyGate screenKey="pharmacy-returns">
      <ReturnsScreen />
    </PharmacyGate>
  );
}
