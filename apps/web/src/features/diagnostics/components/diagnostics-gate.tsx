...
import { diagnosticsScreen } from '../screens';

/**
 * The screen-level permission gate.
 *
 * The same courtesy the admin console, the front office and the clinical screens
 ...
 * radiographer covering the night shift. The screen answers by explaining
...
export function DiagnosticsGate({
  ...
  const screen = diagnosticsScreen(screenKey);
