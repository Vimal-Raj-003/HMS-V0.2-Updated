...
- Patients/staff may ask what footage exists of them (DSAR): the response process is defined in EN-028 — footage of *other* identifiable people cannot be disclosed, so exports for DSAR require redaction or refusal with reasons.
