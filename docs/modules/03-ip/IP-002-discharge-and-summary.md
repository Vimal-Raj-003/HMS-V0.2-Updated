...
1. **Doctor** clicks _Initiate discharge_ (desktop/IP-010) → chooses discharge type (`routine`, `referred/transfer_out`, `dama/lama`, `absconded`, `death`, `day_care_complete`), condition (`recovered/improved/unchanged/deteriorated`), expected exit time, follow-up plan draft.
