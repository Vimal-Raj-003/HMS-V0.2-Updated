...
Defaults: Receptionist: patient.* (except merge/export/override), appointment.*, visit.*; Call centre: appointment.*, patient.read/list; MRD: patient.merge.*, patient.record.update; HOD/Doctor: schedule.configure own; Branch Admin: schedule.publish, counters; Auditor: read/list.
