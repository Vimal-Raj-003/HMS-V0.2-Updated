...
Defaults: ER nurse: visit.create/update, triage.*, bay.assign, oncall.alert, observation, board; EM physician: all clinical incl. disposition, death.declare, mlc.flag, pathway; ER receptionist: visit.create/update (demographics), board.read; specialists: oncall.respond, visit.read; MS: mlc.unflag, reports; Security: mlc read (intimation), belongings; Day-care nurse/coordinator: daycare.*; Auditor: read.
