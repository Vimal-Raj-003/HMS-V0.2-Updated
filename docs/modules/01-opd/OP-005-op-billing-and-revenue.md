...
Defaults: Cashier: bill.read/list, payment.collect, receipt._, discount.apply ≤ limit, refund.request; Billing executive: + bill.create/item._, payer.set, finalize, invoice.cancel (same day); Billing supervisor: discount.approve L2, refund.approve L2; Admin/MS: L3 approvals; Accountant: reports, gst, einvoice, refund.process, configure (series/GL); Doctor: payout.read own; TPA desk: payer.set, credit; Auditor: read/export.
