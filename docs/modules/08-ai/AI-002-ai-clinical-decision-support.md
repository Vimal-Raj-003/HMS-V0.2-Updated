...
- **Resident (14, IP tablet, on rounds)**: ask "why is this alert firing for *this* patient?" and get an explanation
...
- **Intensivist (11)**: surface deterioration and sepsis risk signals hidden in nursing notes and handovers that
  structured NEWS2 has not yet caught, as a *pre-alert* to the deterministic score.
...
4. AI-002 **may** add: an explanation of an EN-029 alert, a plain-language patient-specific rationale, a relevance
   ranking *within* the AI-suggestion area only, and a "possible additional consideration" card that is always
...
6. Every AI-002 card carries the standing statement: *"AI suggestion. Not a diagnosis. Deterministic safety checks are
   shown above and are authoritative."*
...
4. **Alert relevance ranking** (opt-in, shadow-first): AI-002 may score the *predicted usefulness* of passive alerts
...
## 11. Notifications
- Note-derived risk signals → ward tray + EN-037 *informational* only (never a must-acknowledge; that channel belongs
  to EN-029).
